        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolicitadoPor = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    FechaAtencion = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    AtendidoPor = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SolicitudPedidoId = table.Column<int>(type: "integer", nullable: false),
                    ProductoId = table.Column<int>(type: "integer", nullable: false),
                    Cantidad = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallesSolicitud_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetallesSolicitud_Solicitudes_SolicitudPedidoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Referencia = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    Observaciones = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    SolicitudPedidoId = table.Column<int>(type: "integer", nullable: true),
                    RegistradoPor = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Salidas_Solicitudes_SolicitudPedidoId",
                        column: x => x.SolicitudPedidoId,
                        principalTable: "Solicitudes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesSolicitud_ProductoId",
                table: "DetallesSolicitud",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesSolicitud_SolicitudPedidoId",
                table: "DetallesSolicitud",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productos_ClienteId_Codigo",
                table: "Productos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Salidas_SolicitudPedidoId",
                table: "Salidas",
                column: "SolicitudPedidoId");
